...
<table>
	...
	<tbody>
 	...
 	<tr>
		...
		<td>
<?php echo "<a href='editartabladministrador.php?id=".$filas['id']."'>EDITAR</a>"; ?>
			-
<?php echo " <a href='eliminar_tabla_administrador.php?id=".$filas['id']."' onclick='return confirmar()'>ELIMINAR</a>"; ?>
